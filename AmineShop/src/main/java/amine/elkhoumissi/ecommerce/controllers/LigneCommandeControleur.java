...
public class LigneCommandeControleur {
	...
	@RequestMapping("/panier/ajouter/{idProduit}")
	@ResponseStatus(value = HttpStatus.NO_CONTENT)
	public void addCartItem(@PathVariable(value = "idProduit") Long idProduit) {
	...
	@RequestMapping("/panier/supprimerLigneCommande/{idLigneCommande}")
	@ResponseStatus(value = HttpStatus.NO_CONTENT)
	public String removeCartItem(@PathVariable(value = "idLigneCommande") Long idLigneCommande) {
		ligneCommandeMetier.deleteLigneCommande(idLigneCommande);
		return "redirect:/panier/getPanierParId";
	}

	@RequestMapping("/panier/supprimerAllLignesCommande/{idPanier}")
	@ResponseStatus(value = HttpStatus.NO_CONTENT)
	public String removeAllCartItems(@PathVariable(value = "idPanier") Long idPanier) {
