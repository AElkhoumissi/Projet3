...
public class AccueilControleur {
	...
	@RequestMapping(value = "/contactezNous", method = RequestMethod.POST)
	public String addQuery(@Valid @ModelAttribute(value = "contact") MessageClient query, Model model, BindingResult result) {
		...
		model.addAttribute("querySuccess",
				"Merci, votre meassage est enregitré dans notre serveur, nous allons vous répondre le plus"
				+ "rapidement possible");
		return "seConnecter";
