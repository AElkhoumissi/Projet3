	 			...
	 			<div class="row" style="margin-top: 20px">
					...
					<div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3" style="width: 100%; margin-left: 0%; ">
						<div style="text-align: center;"><h1>Reçu</h1></div>
							...
							<button style="float: left;" class="btn btn-lg btn-default" name="_eventId_backToCollectShippingDetail">Précédent</button>
							<input style="margin-left: 200px" type="submit" value="Submit Order" class="btn btn-lg btn-info" name="_eventId_orderConfirmed" />
