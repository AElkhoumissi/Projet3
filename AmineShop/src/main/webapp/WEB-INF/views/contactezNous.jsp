...
<html>
	<head>
		...
		<link rel="stylesheet" href="<c:url value="/resource/css/form-elements.css"/>">
		...
		<div class="top-content">
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2 text">
						<h3>
							<strong>Amine's Shop</strong> Formulaire de contact
						</h3>
						<div class="description">
							<p>Si vous avez besoin de l'aide contactez nous. Ecrivez vos messages.</p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3 form-box">
						...
						<div class="form-bottom contact-form">
							...
							<form:form role="form" method="post" action="${url}" commandName="contact">
								...
								<div class="form-group">
									<label class="sr-only" for="contact-subject">Sujet</label>
									<form:input type="text" path="sujet" class="contact-subject form-control" placeholder="Sujet..." required="required"></form:input>
								</div>
								<div class="form-group">
								...
								<button style="float: right;" type="button" class="btn"
									onclick="window.location.href='<c:url value="/index1" />'">Retour à la page d'accueil
									</button>
							</form:form>
						</div>
					</div>
